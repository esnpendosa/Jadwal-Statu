        ...
        <div class="card border-0 shadow-lg overflow-hidden">
            ...
            <div class="card-header bg-white border-bottom py-3 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="mb-0 fw-black text-dark text-uppercase tracking-tight">Create User Account</h5>
                </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="card-body p-4 p-md-5">
                @csrf
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <div class="input-group border rounded-3 overflow-hidden bg-white shadow-none trans-input">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. John Doe" class="form-control border-0 shadow-none fw-bold small" required>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group border rounded-3 overflow-hidden bg-white shadow-none trans-input">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" placeholder="e.g. user@company.com" class="form-control border-0 shadow-none fw-bold small" required>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="bg-light bg-opacity-50 p-3 rounded-4 border border-dashed text-dark">
                                    <div class="form-check form-switch m-0">
                                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', '1') ? 'checked' : '' }} class="form-check-input" id="isActiveSwitch">
                                        <label class="form-check-label small fw-black text-uppercase tracking-widest cursor-pointer" for="isActiveSwitch">
                                            MARK ACCOUNT AS ACTIVE
                                        </label>
                                    </div>
                                    <small class="extra-small text-muted d-block mt-1">New accounts are active by default and can log in immediately.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="p-4 rounded-4 border border-light h-100" style="background-color: #f8faff;">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <h6 class="extra-small fw-black text-dark text-uppercase tracking-widest mb-0">Initial Credentials</h6>
                            </div>
                            
                            <p class="extra-small text-muted mb-4 italic">
                                Set a secure initial password for the new user.
                            </p>

                            <div class="mb-3">
                                <label class="form-label extra-small fw-bold text-dark text-uppercase">Initial Password <span class="text-danger">*</span></label>
                                <input type="password" name="password" class="form-control form-control-sm border shadow-none" placeholder="Minimum 8 characters" required>
                                @error('password') <div class="extra-small text-danger mt-1 fw-bold">{{ $message }}</div> @enderror
                            </div>
                            
                            <div class="mb-0">
                                <label class="form-label extra-small fw-bold text-dark text-uppercase">Confirm Password <span class="text-danger">*</span></label>
                                <input type="password" name="password_confirmation" class="form-control form-control-sm border shadow-none" required>
                            </div>

                            <div class="mt-4 pt-3 border-top border-light">
                                <div class="extra-small text-muted d-flex align-items-start gap-2">
                                    <i class="bi bi-info-circle-fill text-primary"></i>
                                    <span>User can change their password from profile settings after logging in for the first time.</span>
                                </div>
                            </div>
                        </div>
                    </div>
