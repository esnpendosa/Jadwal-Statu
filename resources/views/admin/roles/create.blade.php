...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="card">
        <div class="card-header border-none pb-0 pt-6">
            <h3 class="text-xl font-bold uppercase tracking-tight text-gray-900 dark:text-white">Create Security Role</h3>
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST" class="card-body">
            ...
            <div class="form-group mb-8 pb-8 border-b border-gray-100 dark:border-gray-800">
                <label class="form-label uppercase font-black tracking-widest text-[10px] text-gray-400">Role Name (Use lowercase slug format, e.g. project-admin) <span class="text-red-500">*</span></label>
                <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. warehouse-manager" class="form-input text-lg font-bold" required>
                @error('name') <p class="form-error">{{ $message }}</p> @enderror
            </div>

            <div class="space-y-6">
                <div class="flex items-center justify-between">
                    <h4 class="text-xs font-bold uppercase tracking-widest text-gray-400 leading-none">Granular Permissions Mapping</h4>
                    ...
                    <div class="card p-4 border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/10 hover:bg-white dark:hover:bg-gray-800 transition-colors">
                        ...
                        <div class="space-y-3">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer group">
                                <input type="checkbox" name="permissions[]" value="{{ $perm->name }}" class="perm-check w-4 h-4 text-primary-600 rounded border-gray-300 focus:ring-primary-500">
            ...
            <div class="mt-12 flex items-center justify-end gap-3 border-t border-gray-100 dark:border-gray-800 pt-6">
                ...
                <button type="submit" class="btn-primary px-8 font-bold">CREATE SECURITY ROLE</button>
            </div>
        </form>
    </div>
</div>
