...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h1 class="h3 fw-black text-dark text-uppercase tracking-tighter mb-0">Tambah Kategori Baru</h1>
        </div>
                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="description" rows="4" 
                            ...
                            placeholder="Jelaskan jenis aset yang masuk dalam kategori ini...">{{ old('description') }}</textarea>
                    </div>

                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-lg rounded-4 py-3 fw-black tracking-widest shadow-lg hover-scale">
                            <i class="bi bi-plus-circle-fill me-2"></i>SIMPAN KATEGORI
                        </button>
                    </div>
                </form>
            </div>
