...
<head>
    ...
    <title>{{ __('Register') }} — {{ config('app.name', 'Smart Inventory') }}</title>
    ...
    <div class="login-wrapper fade-in-up">
        ...
        <div class="brand-panel">
            ...
            <div class="brand-content">
                <h2>Join<br>Network</h2>
                <p>Register as PIC to start managing your assets efficiently.</p>
            </div>
        ...
        <div class="form-panel">
            <div class="mb-4">
                ...
                <p class="form-subtitle">Create your PIC account</p>
            </div>
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <p class="text-center mb-0" style="font-size: 0.85rem; font-weight: 600; color: #64748b;">
                    Already have an account? <a href="{{ route('login') }}" class="text-decoration-none fw-bold" style="color: var(--primary-color);">Login here</a>
                </p>
            </form>
        </div>
    </div>
